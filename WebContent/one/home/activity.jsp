...
<link href="${pageContext.request.contextPath}/one/css/seastyle.css"
	rel="stylesheet" type="text/css" />

<script type="text/javascript"
	src="${pageContext.request.contextPath}/one/basic/js/jquery-1.7.min.js"></script>
<script type="text/javascript"
	src="${pageContext.request.contextPath}/one/js/script.js"></script>
</head>
							...
							<c:forEach items="${activity }" var="activity">
								<li>
									<div class="i-pic limit">
										<c:forEach items="${activity.imgs }" var="img"
											varStatus="status">
											<c:if test="${status.count==1 }">
												<img src="/img/${img.bigImg }" />
											</c:if>
										</c:forEach>
										<p class="title fl">${activity.name }</p>
										<p class="price fl">
											<b>¥</b> <strong>${activity.price }</strong>
										</p>
										<p class="number fl">
											销量<span>${activity.quantity }</span>
										</p>
									</div>
								</li>
					...
					<div class="search-side">
						...
						<li>
							<div class="i-pic check">
								<img src="${pageContext.request.contextPath}/one/images/cp.jpg" />
						...
						<li>
							<div class="i-pic check">
								<img src="${pageContext.request.contextPath}/one/images/cp2.jpg" />
