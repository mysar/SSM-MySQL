...
<link href="${pageContext.request.contextPath}/one/css/cartstyle.css"
	rel="stylesheet" type="text/css" />
<link href="${pageContext.request.contextPath}/one/css/optstyle.css"
	rel="stylesheet" type="text/css" />
<script type="text/javascript"
	src="${pageContext.request.contextPath}/assets/index/shopcart.js"></script>
<script type="text/javascript"
	src="${pageContext.request.contextPath}/one/js/jquery.js"></script>
</head>
			...
			<div class="topMessage">
				<div class="menu-hd">
					<c:choose>
						...
						<c:otherwise>
							<a target="_top" class="h">欢迎,<span style="color: red;">${sessionScope.user.userName}</span></a>
						</c:otherwise>
					</c:choose>
				</div>
			</div>
	...
	<div class="concent">
			...
			<tr class="item-list">
				<div class="bundle  bundle-last ">
					...
					<div class="bundle-main">
						...
						<c:forEach items="${requestScope.cart.details}" var="cartitem">

							<ul class="item-content clearfix">
								<li class="td td-chk">
									<div class="cart-checkbox ">
										<input class=".check" id="J_CheckBox_170037950254"
											name="items[]" value="${cartitem.goods.id}" type="checkbox">
								...
								<li class="td td-item">
									<div class="item-pic">
										<a href="#" target="_blank"
											data-title="${cartitem.goods.name }" class="J_MakePoint"
											data-point="tbcart.8.12"> <c:forEach
												items="${cartitem.goods.imgs}" begin="0" end="1" var="img">
												<img src="/img/${img.bigImg }" class="itempic J_ItemImg"
									...
									<div class="item-info">
										<div class="item-basic-info">
											<a href="#" target="_blank" title="${cartitem.goods.name }"
												class="item-title J_MakePoint" data-point="tbcart.8.11">${cartitem.goods.name}</a>
										</div>
									</div>
								</li>
								<li class="td td-info">
								...
								<li class="td td-price">
									<div class="item-price price-promo-promo">
										<div class="price-content">
											...
											<div class="price-line">
												<em class="J_Price price-now" tabindex="0">${cartitem.goods.price}</em>
											</div>
										</div>
									</div>
								</li>
										...
										<div class="item-amount ">
											<div class="sl">
												...
												<input class="text_box" name="" type="text"
													value="${cartitem.num}" style="width: 30px;" /> <input
								...
								<li class="td td-op">
									<div class="td-inner">
										<a title="移入收藏夹" class="btn-fav" href="#"> 移入收藏夹</a> <a
											href="${pageContext.request.contextPath }/Cart/deleteCartItem?id=${cartitem.goods.id}"
		...
		<div class="float-bar-wrapper">
			...
			<div class="operations">
				<a href="javascript:deleteselect();" hidefocus="true"
					class="deleteAll">删除</a> <a href="#" hidefocus="true"
					class="J_BatchFav">移入收藏夹</a>
			</div>
			<div class="float-bar-right">
				<div class="amount-sum">
					<span class="txt">已选商品</span> <em id="J_SelectedItemsCount">${requestScope.num}</em><span
						class="txt">件</span>
					<div class="arrow-box">
				...
				<div class="price-sum">
					<span class="txt">合计:</span> <strong class="price">¥<em
						id="J_Total">${requestScope.cart.totalPrice}</em></strong>
				</div>
				<div class="btn-area">
					<a href="${pageContext.request.contextPath }/Cart/saveOrders"
