...
<link href="${pageContext.request.contextPath}/one/css/personal.css"
	rel="stylesheet" type="text/css">
<link href="${pageContext.request.contextPath}/one/css/infstyle.css"
	rel="stylesheet" type="text/css">
<script
	src="${pageContext.request.contextPath}/one/AmazeUI-2.4.2/assets/js/jquery.min.js"
	type="text/javascript"></script>
<script
	src="${pageContext.request.contextPath}/one/AmazeUI-2.4.2/assets/js/amazeui.js"
	type="text/javascript"></script>
	...
	<div class="center">
					...
					<div class="info-main">
						<form class="am-form am-form-horizontal"
							...
							<div class="am-form-group">
								...
								<div class="am-form-content">
									<input type="text" name="name" id="user-name2"
										required="required" placeholder="name" value="${user.name }">
								</div>
							</div>
									...
									<c:choose>
										<c:when test="${user.sex=='男' }">
											<label class="am-radio-inline"> <input type="radio"
												name="sex" value="男" data-am-ucheck checked="checked">
												男
											</label>
											<label class="am-radio-inline"> <input type="radio"
										...
										<c:when test="${user.sex=='女' }">
											...
											<label class="am-radio-inline"> <input type="radio"
												name="sex" value="女" data-am-ucheck checked="checked">
												女
											</label>
										</c:when>
									</c:choose>
							...
							<div class="am-form-group">
								...
								<div class="am-form-content">
									<input id="user-phone" placeholder="telephonenumber"
										name="phone" pattern="^1[3|4|5|7|8][0-9]{9}$"
										data-validation-message="请输入正确的手机号" type="tel"
										value="${user.phone }">
								</div>
							</div>
							<div class="am-form-group">
								...
								<div class="am-form-content">
									<input id="user-email" placeholder="Email" name="email"
		...
		<aside class="menu">
			<ul>
				...
				<li class="person"><a
					href="${pageContext.request.contextPath }/User/index">个人资料</a>
					<ul>
						<li class="active"><a
							href="${pageContext.request.contextPath }/User/index">个人信息</a></li>
						<li><a href="safety.html">安全设置</a></li>
						<li><a
							href="${pageContext.request.contextPath }/User/getAddress">收货地址</a></li>
					</ul></li>
