...
<link href="${pageContext.request.contextPath}/one/css/dlstyle.css"
...
<body>
	...
	<div class="login-boxtitle">
		<a href="home.html"><img alt="logo"
			src="${pageContext.request.contextPath}/one/images/logobig.png" /></a>
	</div>
	...
	<div class="login-banner">
		<div class="login-main">
			<div class="login-banner-bg">
				<span></span><img
					src="${pageContext.request.contextPath}/one/images/big.jpg" />
			</div>
			<div class="login-box">
					...
					<form id="ff" method="post"
						...
						<div class="user-pass">
							<label for="password"><i class="am-icon-lock"></i></label> <input
								...
								type="hidden" name="admin" value="0" />
						</div>
					</form>
				</div>
