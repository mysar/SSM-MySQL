...
<body>
	...
	<div class="center">
		<div class="col-main">
			<div class="main-wrap">
				<div style="width: 300px; height: 100px; margin: 250px auto;">
					<p>
						<img
							src="${pageContext.request.contextPath }/one/images/T13iv.XiFdXXa94Hfd-32-32.png"
							style="vertical-align: text-bottom; padding-right: 30px;"><span> 用户信息修改成功！</span>
					</p>
				</div>
			</div>
			<!--底部-->
