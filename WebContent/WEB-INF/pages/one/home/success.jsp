...
<link href="${pageContext.request.contextPath}/one/css/sustyle.css"
	rel="stylesheet" type="text/css" />
	...
	<div class="take-delivery">
		<div class="status">
			...
			<div class="successInfo">
				<ul>
					<li>付款金额<em>¥${cart.totalPrice}</em></li>
					<div class="user-info">
						<p>收货人：${user.name}</p>
						<p>联系电话：${user.phone}</p>
				...
				<div class="option">
					<span class="info">您可以</span> <a
						href="${pageContext.request.contextPath}/one/person/order.html"
						class="J_MakePoint">查看<span>已买到的宝贝</span></a> <a href="#"
