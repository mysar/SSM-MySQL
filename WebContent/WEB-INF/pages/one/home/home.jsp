...
<link href="${pageContext.request.contextPath}/one/css/hmstyle.css" rel="stylesheet" type="text/css" />
<link href="${pageContext.request.contextPath}/one/css/skin.css" rel="stylesheet" type="text/css" />
<script src="${pageContext.request.contextPath}/one/AmazeUI-2.4.2/assets/js/jquery.min.js"></script>
<script src="${pageContext.request.contextPath}/one/AmazeUI-2.4.2/assets/js/amazeui.min.js"></script>
</head>
						...
						<div class='recommendationMain one'>
							<c:forEach items="${hoteGoods.imgs }" var="imgs"
								...
								<c:if test="${statu.count==1 }">
									<a
										href="${pageContext.request.contextPath }/index/goods.do?gid=${hoteGoods.id }">
