...
<body>
	 <div class="easyui-panel" style="width:100%;max-width:400px;padding:30px 60px;">
        <form id="ff" class="easyui-form" method="post" data-options="novalidate:true">
            <div style="margin-bottom:20px">
                <input class="easyui-textbox" name="name" value="${entity.name}" style="width:100%" data-options="label:'活动名:'">
            </div>
            <div style="margin-bottom:20px">
                <input class="easyui-textbox" name="remark" value="${entity.remark}" style="width:100%" data-options="label:'活动介绍:'">
            </div>
    ...
    <script>
        function submitForm(){
            $('#ff').form('submit',{
                url:"../change/updateActivity.action",
                onSubmit:function(){
