...
<body>
		...
		<form id="ff" class="easyui-form" method="post"
			...
			<div style="margin-bottom: 20px">
				<input class="easyui-textbox" name="address" style="width: 80%"
					value="${address.address}" data-options="label:'收货地址'">
			</div>
			
			<div style="margin-bottom: 20px">
				<input class="easyui-textbox" name="name" style="width: 80%"
					value="${address.name}" data-options="label:'收货人姓名'">
			</div>
			<div style="margin-bottom: 20px">
				<input class="easyui-numberbox" name="phone" style="width: 80%"
					value="${address.phone}" data-options="label:'收货人电话'">
			</div>
		<div style="margin-bottom: 20px">
				<input class="easyui-combobox" id="user" name="uid"
					value="${address.pname}" style="width: 80%"
					data-options="label:'所属用户'">
			</div>
	...
	<script>
		...
		function submitForm() {
			$('#ff').form('submit', {
				url : "../change/addressUpdate.action",
				onSubmit : function() {
